...
int main(int argc, char * argv[]) {
  ...
  for (int iF=ifile; iF<1; ++iF) {
    ...
    for (Long64_t iEntry=0; iEntry<numberOfEntries; iEntry++) {
      ...
      //      if(!(analysisTree.event_nr==2305939)) continue;
      // if(!((analysisTree.event_run == 1 && analysisTree.event_nr == 541966 && analysisTree.event_luminosityblock == 1000)||(analysisTree.event_run == 1 && analysisTree.event_nr == 542009 && analysisTree.event_luminosityblock == 1001)||(analysisTree.event_run == 1 && analysisTree.event_nr == 542170 && analysisTree.event_luminosityblock == 1001)||(analysisTree.event_run == 1 && analysisTree.event_nr == 542322 && analysisTree.event_luminosityblock == 1001))) continue;
      //                 if(!(analysisTree.event_run == 1 && analysisTree.event_nr == 542009 && analysisTree.event_luminosityblock == 1001)) continue; 1 tau only due to rounding
      //    if(!(analysisTree.event_run == 1 && analysisTree.event_nr == 544012 && analysisTree.event_luminosityblock == 1003)) continue; 1 tau due to rounding
      // if(!(analysisTree.event_run == 1 && analysisTree.event_nr == 544023 && analysisTree.event_luminosityblock == 1003)) continue; did not pass ditau trigger

      //      if(!((analysisTree.event_run == 1 && analysisTree.event_nr == 533511 && analysisTree.event_luminosityblock == 985)||(analysisTree.event_run == 1 && analysisTree.event_nr == 533519 && analysisTree.event_luminosityblock == 985)||(analysisTree.event_run == 1 && analysisTree.event_nr == 533602 && analysisTree.event_luminosityblock == 985)||(analysisTree.event_run == 1 && analysisTree.event_nr == 533634 && analysisTree.event_luminosityblock == 985)||(analysisTree.event_run == 1 && analysisTree.event_nr == 533623 && analysisTree.event_luminosityblock == 985))) continue; 

      //  if(!((analysisTree.event_run == 1 && analysisTree.event_nr == 542009 && analysisTree.event_luminosityblock == 1001)||(analysisTree.event_run == 1 && analysisTree.event_nr == 544012 && analysisTree.event_luminosityblock == 1003)||(analysisTree.event_run == 1 && analysisTree.event_nr == 592714 && analysisTree.event_luminosityblock == 1093)||(analysisTree.event_run == 1 && analysisTree.event_nr == 612742 && analysisTree.event_luminosityblock == 1131)||(analysisTree.event_run == 1 && analysisTree.event_nr == 617276 && analysisTree.event_luminosityblock == 1139))) continue; 

      //  if(!((analysisTree.event_run == 1 && analysisTree.event_nr == 640365 && analysisTree.event_luminosityblock == 1081)||(analysisTree.event_run == 1 && analysisTree.event_nr == 665515 && analysisTree.event_luminosityblock == 1228)||(analysisTree.event_run == 1 && analysisTree.event_nr == 672371 && analysisTree.event_luminosityblock == 1241)||(analysisTree.event_run == 1 && analysisTree.event_nr == 704563 && analysisTree.event_luminosityblock == 1300)||(analysisTree.event_run == 1 && analysisTree.event_nr == 771464 && analysisTree.event_luminosityblock == 1423))) continue;

      //  if(!((analysisTree.event_run == 1 && analysisTree.event_nr == 1824867 && analysisTree.event_luminosityblock == 3367)||(analysisTree.event_run == 1 && analysisTree.event_nr == 1832416 && analysisTree.event_luminosityblock == 3381)||(analysisTree.event_run == 1 && analysisTree.event_nr == 1832874 && analysisTree.event_luminosityblock == 3381)||(analysisTree.event_run == 1 && analysisTree.event_nr == 1844226 && analysisTree.event_luminosityblock == 3403)||(analysisTree.event_run == 1 && analysisTree.event_nr == 1844226 && analysisTree.event_luminosityblock == 3407))) continue; 

      //if(!((analysisTree.event_run == 1 && analysisTree.event_nr == 1497372 && analysisTree.event_luminosityblock == 2763)||(analysisTree.event_run == 1 && analysisTree.event_nr == 1497499 && analysisTree.event_luminosityblock == 2763)||(analysisTree.event_run == 1 && analysisTree.event_nr == 1497981 && analysisTree.event_luminosityblock == 2763)||(analysisTree.event_run == 1 && analysisTree.event_nr == 1500444 && analysisTree.event_luminosityblock == 2769)||(analysisTree.event_run == 1 && analysisTree.event_nr == 1500969 && analysisTree.event_luminosityblock == 2769))) continue; 

      //if(!((analysisTree.event_run == 1 && analysisTree.event_nr == 34273 && analysisTree.event_luminosityblock == 63)||(analysisTree.event_run == 1 && analysisTree.event_nr == 34309 && analysisTree.event_luminosityblock == 63)||(analysisTree.event_run == 1 && analysisTree.event_nr == 364133 && analysisTree.event_luminosityblock == 671)||(analysisTree.event_run == 1 && analysisTree.event_nr == 371644 && analysisTree.event_luminosityblock == 685)||(analysisTree.event_run == 1 && analysisTree.event_nr == 374801 && analysisTree.event_luminosityblock == 691))) continue; 
